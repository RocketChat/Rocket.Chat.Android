...
class Config {
    companion object {
        ...
        const val userAvatar: String = "https://open.rocket.chat/avatar/userName?format=jpeg&rc_uid=null&rc_token=null"
        const val EMAIL: String = "abc@gmail.com"
        const val USERNAME: String = "user"
        const val PASSWORD: String = "abc12345"
        const val TERMS_OF_SERVICE: String = "Terms of Service"
        const val PRIVACY_POLICY: String = "Privacy Policy"
        const val termsOfServiceUrl: String = "https://open.rocket.chat/terms-of-service"
        const val privacyPolicyUrl: String = "https://open.rocket.chat/privacy-policy"
    }
