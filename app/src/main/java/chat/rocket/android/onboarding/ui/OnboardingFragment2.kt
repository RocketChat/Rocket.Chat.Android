...
class OnboardingFragment2 : Fragment(), PageTransformerView {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        view.text_message.text = resources.getString(R.string.onBoarding_title2)
        view.text_description.text = resources.getString(R.string.onBoarding_description2)
        view.tag = this
        return view
    }
