...
class ChatRoomActionBottomSheet : BottomSheetDialogFragment() {

  private var adapter = ChatRoomActionAdapter()
  ...
  private class ChatRoomActionAdapter : RecyclerView.Adapter<ChatRoomActionViewHolder>() {

    private lateinit var itemClickListener: ActionItemClickListener
    private val menuItems = mutableListOf<MenuItem>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChatRoomActionViewHolder {
      return ChatRoomActionViewHolder(
    ...
    override fun onBindViewHolder(holder: ChatRoomActionViewHolder, position: Int) {
  ...
  private class ChatRoomActionViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
