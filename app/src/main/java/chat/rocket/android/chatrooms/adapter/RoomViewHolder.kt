...
class RoomViewHolder(itemView: View, private val listener: (RoomUiModel) -> Unit) :
    ...
    private val channelIcon: Drawable = resources.getDrawable(R.drawable.ic_megaphone)
    private val groupIcon: Drawable = resources.getDrawable(R.drawable.ic_community)
